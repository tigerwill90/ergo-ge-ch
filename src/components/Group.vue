<template>
  <FlexContainer column align-items="center">
    ...
    <p class="group-desc headline text-xs-center">
      ...
      <strong style="color: teal">du secteur public, dans le secteur subventionné, mais également dans le privé</strong
      >. Selon l'organisation des services auxquels ils sont rattachés, les ergothérapeutes ont donc à faire à des
      populations très diversifiées.
    </p>
    <div class="group-list">
      <div class="group-public">
        <h1 class="app-section-title title-2 text-xs-center">
      ...
      <div class="group-private">
        <h1 class="app-section-title title-2 text-xs-center">Secteur privé</h1>
        <p class="subheading paragraph">
          Les ergothérapeutes qui s'installent à leur compte développent en principe une pratique indépendante dans l'un
          des domaines de l'ergothérapie en particulier (par exemple : la pédiatrie, la psychiatrie, la gériatrie ou
          encore la médecine physique...).
        </p>
      </div>
    </div>
  </FlexContainer>
